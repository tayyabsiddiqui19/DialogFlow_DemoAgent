...
app.intent("Default Welcome Intent", (conv) => {
  ...
  conv.ask(new Suggestions(['Educational Experience', "Professional Experience", "Skills", "Business Card"]));

})

app.intent("Educational Experience", (conv) => {
  conv.ask(new SimpleResponse("I'm an Electronic Engineer graduated from NED University in 2016"));
  conv.ask(new Suggestions(["Professional Experience", "Skills", "Business Card"]));
...
app.intent("Professional Experience", (conv) => {
  ...
  conv.ask(text1);
  conv.ask(new Suggestions(["Educational Experience", "Skills", "Business Card"]));
...
app.intent("Skills", (conv) => {
  ...
  conv.ask(skills);
  conv.ask(new Suggestions(["Educational Experience", "Professional Experience", "Business Card"]));
  // conv.ask(new Suggestions("Professional Experience"));
})
...
app.intent("Business Card", (conv) => {
  ...
  conv.ask(card);
  conv.ask(new Suggestions(["Educational Experience", "Professional Experience", "Skills"]));
